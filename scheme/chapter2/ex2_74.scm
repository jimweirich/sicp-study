...
;; in her first attempt to exploit the ability of the network to
;; extract administrative information from division files, is dismayed
...
;; a set (structured differently from division to division) that
...
;; file. The procedure should be applicable to any division's
;; file. Explain how the individual divisions' files should be
