...
You will find the worked examples in Scheme in the scheme directory of this project.  Each week's work will be its own directory.  Examples will be named +ex._x_._y_.scm+ (where _x.y_ is the exercise number).  The book_code.scm will contain any interesting code snippets from the book in the assigned reading for that week.
